...
Config.Pictures = {
    ...
    CHAR_REDSIDE_BOL                    = "CHAR_REDSIDE_bol.jpg",
    CHAR_REDSIDE_FLEECA                 = "CHAR_REDSIDE_fleeca.jpg",
    CHAR_REDSIDE_MAZE                   = "CHAR_REDSIDE_maze.jpg",
    ...
    CHAR_LSCITY = "Char_lscity.png",
    CHAR_GCITY = "Char_gcity.png",
    CHAR_REDSIDE = "CHAR_REDSIDE.png",
}
